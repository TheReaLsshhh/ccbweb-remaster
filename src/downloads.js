              ...
              <div className="forms-grid">
                <div className="form-item">
                  ...
                  <div className="form-content">
                    ...
                    <a href="#" className="download-btn primary-btn">
                ...
                <div className="form-item">
                  ...
                  <div className="form-content">
                    ...
                    <a href="#" className="download-btn secondary-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
                      <span>Download PDF</span>
                ...
                <div className="form-item">
                  ...
                  <div className="form-content">
                    ...
                    <a href="#" className="download-btn danger-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
                      <span>Download PDF</span>
              ...
              <div className="handbooks-grid">
                <div className="handbook-item">
                  ...
                  <div className="handbook-content">
                    ...
                    <a href="#" className="download-btn gradient-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
                ...
                <div className="handbook-item">
                  ...
                  <div className="handbook-content">
                    ...
                    <a href="#" className="download-btn info-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
                ...
                <div className="handbook-item">
                  ...
                  <div className="handbook-content">
                    ...
                    <a href="#" className="download-btn warning-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
                ...
                <div className="handbook-item">
                  ...
                  <div className="handbook-content">
                    ...
                    <a href="#" className="download-btn success-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
              ...
              <div className="resources-grid">
                <div className="resource-item">
                  ...
                  <div className="resource-content">
                    ...
                    <a href="#" className="download-btn professional-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
                      <span>Download PDF</span>
                ...
                <div className="resource-item">
                  ...
                  <div className="resource-content">
                    ...
                    <a href="#" className="download-btn research-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
                      <span>Download PDF</span>
                ...
                <div className="resource-item">
                  ...
                  <div className="resource-content">
                    ...
                    <a href="#" className="download-btn academic-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
                      <span>Download PDF</span>
                ...
                <div className="resource-item">
                  ...
                  <div className="resource-content">
                    ...
                    <a href="#" className="download-btn template-btn">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/>
                      </svg>
